...
% =========================================================================
% The following file is Adapted  From Willy mutschler, for the Exam of 
% Computationnal Macroeconomics.
%
%  copy and paste to execute "Andreasen_2012_rare_disasters_V1" 
%==========================================================================
%--------------------------------------------------------------------------
% Declarations
%--------------------------------------------------------------------------
...
%% The following part calculates the third-order perturbation solution!
...
gsss = oo_.dr.ghs3(indxy,:); % this given by the fonctoin "get ghs3"
